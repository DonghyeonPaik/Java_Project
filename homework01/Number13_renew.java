...
public class Number13_renew {
	public static void main(String[] args) {
		...
		while(inputMoney>0) {
			if(inputMoney>=50000) {
				amount[0] = inputMoney/50000;
				inputMoney%=50000;
			}
			else if(inputMoney>=10000) {
				amount[1] = inputMoney/10000;
				inputMoney%=10000;
			}
			else if(inputMoney>=1000) {
				amount[2] = inputMoney/1000;
				inputMoney%=1000;
			}
			else if(inputMoney>=500) {
				amount[3] = inputMoney/500;
				inputMoney%=500;
			}
			else if(inputMoney>=100) {
				amount[4] = inputMoney/100;
				inputMoney%=100;
			}
			else if(inputMoney>=50) {
				amount[5] = inputMoney/50;
				inputMoney%=50;
			}
			else if(inputMoney>=10) {
				amount[6] = inputMoney/10;
				inputMoney%=10;
			}
			else {
				amount[7] = inputMoney;
